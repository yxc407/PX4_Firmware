if(ENABLE_LOCKSTEP_SCHEDULER STREQUAL "no")
	...
	if(FGFS_PATH)
		...
		tc_add_git_submodule(TARGET git_flightgear_bridge PATH "${TC_SOURCE_DIR}/Tools/simulation/flightgear/flightgear_bridge")

		include(ExternalProject)
		ExternalProject_Add(flightgear_bridge
			SOURCE_DIR ${TC_SOURCE_DIR}/Tools/simulation/flightgear/flightgear_bridge
			CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
			BINARY_DIR ${TC_BINARY_DIR}/build_flightgear_bridge
			INSTALL_COMMAND ""
		...
		file(GLOB flightgear_airframes
			...
			${TC_SOURCE_DIR}/ROMFS/tcfmu_common/init.d-posix/airframes/*_flightgear_*
		)
		...
		add_custom_target(flightgear
			COMMAND ${TC_SOURCE_DIR}/Tools/simulation/flightgear/sitl_run.sh $<TARGET_FILE:tc> "rascal" ${TC_SOURCE_DIR} ${TC_BINARY_DIR}
			WORKING_DIRECTORY ${SITL_WORKING_DIR}
			USES_TERMINAL
			DEPENDS tc flightgear_bridge
		)
		...
		foreach(model ${models})
			...
			add_custom_target(flightgear_${model}
				COMMAND ${TC_SOURCE_DIR}/Tools/simulation/flightgear/sitl_run.sh $<TARGET_FILE:tc> ${model} ${TC_SOURCE_DIR} ${TC_BINARY_DIR}
				WORKING_DIRECTORY ${SITL_WORKING_DIR}
				USES_TERMINAL
				DEPENDS tc flightgear_bridge
			)
