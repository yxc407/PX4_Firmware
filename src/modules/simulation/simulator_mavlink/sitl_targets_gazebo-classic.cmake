...
if(gazebo_FOUND)
	...
	tc_add_git_submodule(TARGET git_sitl_gazebo-classic PATH "${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_gazebo-classic")
	include(ExternalProject)
	ExternalProject_Add(sitl_gazebo-classic
		SOURCE_DIR ${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_gazebo-classic
		CMAKE_ARGS
			-DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
			-DSEND_ODOMETRY_DATA=ON
			-DGENERATE_ROS_MODELS=ON
		BINARY_DIR ${TC_BINARY_DIR}/build_gazebo-classic
		INSTALL_COMMAND ""
	...
	file(GLOB gazebo-classic_airframes
		RELATIVE ${TC_SOURCE_DIR}/ROMFS/tcfmu_common/init.d-posix/airframes
		${TC_SOURCE_DIR}/ROMFS/tcfmu_common/init.d-posix/airframes/*_gazebo-classic_*
	)
	...
	foreach(gazebo-classic_airframe IN LISTS gazebo-classic_airframes)
		...
		if(EXISTS "${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_gazebo-classic/models/${model_only}")

			if((EXISTS "${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_gazebo-classic/models/${model_only}/${model_only}.sdf")
			OR (EXISTS "${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_gazebo-classic/models/${model_only}/${model_only}.sdf.jinja"))
			...
			message(WARNING "model directory ${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_gazebo-classic/models/${model_only} not found")
		endif()
	endforeach()
			...
			foreach(world ${worlds})
				if(world STREQUAL "none")
					...
					add_custom_target(${_targ_name}
						COMMAND ${TC_SOURCE_DIR}/Tools/simulation/gazebo-classic/sitl_run.sh $<TARGET_FILE:tc> ${debugger} ${model} ${world} ${TC_SOURCE_DIR} ${TC_BINARY_DIR}
						WORKING_DIRECTORY ${SITL_WORKING_DIR}
						USES_TERMINAL
						DEPENDS tc sitl_gazebo-classic
					)
					...
					add_custom_target(${_targ_name_compat}
						...
						COMMAND ${CMAKE_COMMAND} --build ${TC_BINARY_DIR} -- ${_targ_name}
						USES_TERMINAL
						VERBATIM
					)
				else()
	...
	ExternalProject_Add(mavsdk_tests
		SOURCE_DIR ${TC_SOURCE_DIR}/test/mavsdk_tests
		CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
		BINARY_DIR ${TC_BINARY_DIR}/mavsdk_tests
		INSTALL_COMMAND ""
		USES_TERMINAL_CONFIGURE true
		USES_TERMINAL_BUILD true
		EXCLUDE_FROM_ALL true
