...
if(JSBSIM_INCLUDE_DIR)
	...
	tc_add_git_submodule(TARGET git_jsbsim_bridge PATH "${TC_SOURCE_DIR}/Tools/simulation/jsbsim/jsbsim_bridge")

	include(ExternalProject)
	ExternalProject_Add(jsbsim_bridge
		SOURCE_DIR ${TC_SOURCE_DIR}/Tools/simulation/jsbsim/jsbsim_bridge
		CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
		BINARY_DIR ${TC_BINARY_DIR}/build_jsbsim_bridge
		INSTALL_COMMAND ""
	...
	file(GLOB jsbsim_airframes
		...
		${TC_SOURCE_DIR}/ROMFS/tcfmu_common/init.d-posix/airframes/*_jsbsim_*
	)
	...
	add_custom_target(jsbsim
		COMMAND ${TC_SOURCE_DIR}/Tools/simulation/jsbsim/sitl_run.sh $<TARGET_FILE:tc> "rascal" "LSZH" ${TC_SOURCE_DIR} ${TC_BINARY_DIR}
		WORKING_DIRECTORY ${SITL_WORKING_DIR}
		USES_TERMINAL
		DEPENDS tc jsbsim_bridge
	)
		...
		foreach(world ${worlds})
			if(world STREQUAL "none")
				add_custom_target(jsbsim_${model}
					COMMAND ${TC_SOURCE_DIR}/Tools/simulation/jsbsim/sitl_run.sh $<TARGET_FILE:tc> ${model} "LSZH" ${TC_SOURCE_DIR} ${TC_BINARY_DIR}
					WORKING_DIRECTORY ${SITL_WORKING_DIR}
					USES_TERMINAL
					DEPENDS tc jsbsim_bridge
				)
				...
				add_custom_target(jsbsim_${model}__${world}
					COMMAND ${TC_SOURCE_DIR}/Tools/simulation/jsbsim/sitl_run.sh $<TARGET_FILE:tc> ${model} ${world} ${TC_SOURCE_DIR} ${TC_BINARY_DIR}
					WORKING_DIRECTORY ${SITL_WORKING_DIR}
					USES_TERMINAL
					DEPENDS tc jsbsim_bridge
				)
