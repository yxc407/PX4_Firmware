...
class BlockLocalPositionEstimator : public ModuleBase<BlockLocalPositionEstimator>, public ModuleParams,
	public tc::WorkItem, public control::SuperBlock
{
// dynamics:
//
//	x(+) = A * x(-) + B * u(+)
...
private:
	...
	DEFINE_PARAMETERS(
		// general parameters
		(ParamInt<tc::params::LPE_FUSION>) _param_lpe_fusion,
		(ParamFloat<tc::params::LPE_VXY_PUB>) _param_lpe_vxy_pub,
		(ParamFloat<tc::params::LPE_Z_PUB>) _param_lpe_z_pub,

		// sonar parameters
		(ParamFloat<tc::params::LPE_SNR_Z>) _param_lpe_snr_z,
		(ParamFloat<tc::params::LPE_SNR_OFF_Z>) _param_lpe_snr_off_z,

		// lidar parameters
		(ParamFloat<tc::params::LPE_LDR_Z>) _param_lpe_ldr_z,
		(ParamFloat<tc::params::LPE_LDR_OFF_Z>) _param_lpe_ldr_off_z,

		// accel parameters
		(ParamFloat<tc::params::LPE_ACC_XY>) _param_lpe_acc_xy,
		(ParamFloat<tc::params::LPE_ACC_Z>) _param_lpe_acc_z,

		// baro parameters
		(ParamFloat<tc::params::LPE_BAR_Z>) _param_lpe_bar_z,

		// gps parameters
		(ParamFloat<tc::params::LPE_GPS_DELAY>) _param_lpe_gps_delay,
		(ParamFloat<tc::params::LPE_GPS_XY>) _param_lpe_gps_xy,
		(ParamFloat<tc::params::LPE_GPS_Z>) _param_lpe_gps_z,
		(ParamFloat<tc::params::LPE_GPS_VXY>) _param_lpe_gps_vxy,
		(ParamFloat<tc::params::LPE_GPS_VZ>) _param_lpe_gps_vz,
		(ParamFloat<tc::params::LPE_EPH_MAX>) _param_lpe_eph_max,
		(ParamFloat<tc::params::LPE_EPV_MAX>) _param_lpe_epv_max,

		// vision parameters
		(ParamFloat<tc::params::LPE_VIS_XY>) _param_lpe_vis_xy,
		(ParamFloat<tc::params::LPE_VIS_Z>) _param_lpe_vis_z,
		(ParamFloat<tc::params::LPE_VIS_DELAY>) _param_lpe_vis_delay,

		// mocap parameters
		(ParamFloat<tc::params::LPE_VIC_P>) _param_lpe_vic_p,

		// flow parameters
		(ParamFloat<tc::params::LPE_FLW_OFF_Z>) _param_lpe_flw_off_z,
		(ParamFloat<tc::params::LPE_FLW_SCALE>) _param_lpe_flw_scale,
		(ParamInt<tc::params::LPE_FLW_QMIN>) _param_lpe_flw_qmin,
		(ParamFloat<tc::params::LPE_FLW_R>) _param_lpe_flw_r,
		(ParamFloat<tc::params::LPE_FLW_RR>) _param_lpe_flw_rr,

		// land parameters
		(ParamFloat<tc::params::LPE_LAND_Z>) _param_lpe_land_z,
		(ParamFloat<tc::params::LPE_LAND_VXY>) _param_lpe_land_vxy,

		// process noise
		(ParamFloat<tc::params::LPE_PN_P>) _param_lpe_pn_p,
		(ParamFloat<tc::params::LPE_PN_V>) _param_lpe_pn_v,
		(ParamFloat<tc::params::LPE_PN_B>) _param_lpe_pn_b,
		(ParamFloat<tc::params::LPE_PN_T>) _param_lpe_pn_t,
		(ParamFloat<tc::params::LPE_T_MAX_GRADE>) _param_lpe_t_max_grade,

		(ParamFloat<tc::params::LPE_LT_COV>) _param_lpe_lt_cov,
		(ParamInt<tc::params::LTEST_MODE>) _param_ltest_mode,

		// init origin
		(ParamInt<tc::params::LPE_FAKE_ORIGIN>) _param_lpe_fake_origin,
		(ParamFloat<tc::params::LPE_LAT>) _param_lpe_lat,
		(ParamFloat<tc::params::LPE_LON>) _param_lpe_lon
	)
