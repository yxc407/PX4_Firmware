#!/bin/bash
#
# Setup environment to make TC visible to Gazebo.
#
# Note, this is not necessary if using a ROS catkin workspace with the tc
# package as the paths are exported.
#
# License: according to LICENSE.md in the root directory of the TC Firmware repository
