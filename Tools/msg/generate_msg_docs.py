...
if __name__ == "__main__":
    ...
    for msg_file in msg_files:
        ...
        #Format msg url
        msg_url="[source file](https://github.com/TC/TC-Autopilot/blob/main/msg/%s)" % msg_file
...
:::note
This list is [auto-generated](https://github.com/TC/TC-Autopilot/blob/main/Tools/msg/generate_msg_docs.py) from the source code.
:::

This topic lists the UORB messages available in TC (some of which may be may be shared by the [TC-ROS 2 Bridge](../ros/ros2_comm.md)).
