...
The following pages document the TC modules, drivers and commands.
...
in the [TC-Autopilot](https://github.com/TC/TC-Autopilot) repository.
The documentation pages can be generated by running the following command from
the root of the TC-Autopilot directory:
...
"""
    ...
    def _ProcessModules(self, module_list):
        ...
        for module in module_list:
            result += "## %s\n" % module.name()
            result += "Source: [%s](https://github.com/TC/TC-Autopilot/tree/main/src/%s)\n\n" % (module.scope(), module.scope())
