...
:::note
**This list is [auto-generated](https://github.com/TC/TC-Autopilot/blob/main/Tools/tcairframes/markdownout.py) from the source code** using the build command: `make airframe_metadata`.
:::
