...
TC_SITL_GAZEBO_PATH = "Tools/simulation/gazebo-classic/sitl_gazebo-classic"

TC_GAZEBO_MODELS = TC_SITL_GAZEBO_PATH + "/models"
TC_GAZEBO_WORLDS = TC_SITL_GAZEBO_PATH + "/worlds"
...
class Px4Runner(Runner):
    def __init__(self, workspace_dir: str, log_dir: str,
        ...
        self.name = "tc"
        self.cmd = os.path.join(workspace_dir, build_dir, "bin/tc")
        ...
        self.env["TC_SIM_MODEL"] = "gazebo-classic_" + self.model
        self.env["TC_SIM_SPEED_FACTOR"] = str(speed_factor)
...
class GzserverRunner(Runner):
    def __init__(self,
        ...
        self.env["GAZEBO_MODEL_PATH"] = \
            os.path.join(workspace_dir, TC_GAZEBO_MODELS)
        self.env["TC_SIM_SPEED_FACTOR"] = str(speed_factor)
        self.cmd = "stdbuf"
