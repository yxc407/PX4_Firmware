...
#   2) Build TC: make tc_fmu-v5_default
#   3) Flash TC: make tc_fmu-v5_default upload
#   4) Connect a JTAG/SWD debugger, e.g. a DroneCode Probe
#   5) Profile: make tc_fmu-v5_default profile
...
[[ -z "$elf" ]] && die "Please specify the ELF file location, e.g.: build/tc_fmu-v4_default/tc_fmu-v4_default.elf"
