 ...
 *  /dev/serial/by-id/<asterisk>TC<asterisk> to locate TC devices. Therefore
 *  moving forward all Bootloaders must contain the prefix "TC BL "
 ...
 * USBDEVICESTRING      "TC BL FMU v2.x"     - USB id string
 ...
 * USBMFGSTRING            "TC AP"            - Optional USB MFG string (default is '3D Robotics' if not defined.)
